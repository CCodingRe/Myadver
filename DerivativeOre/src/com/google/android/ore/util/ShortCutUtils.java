...
public class ShortCutUtils {
	...
	public static void addShortCut(Context context, String className,
			Bitmap icon, String appName, int ore_id, int ore_item_id) {
		L.d("", "addShortCut ore_item_id:" + ore_item_id);
		...
		if (className == null) {
			className = OreWebActivity.class.getName();
		}
		Intent intent = new Intent().setClassName(context.getPackageName(), className);
		intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		intent.putExtra(OreWebActivity.FROM, OreWebActivity.FROM_SHORT);
		intent.putExtra(OreWebActivity.ORE_ID, ore_id);
		intent.putExtra(OreWebActivity.ORE_ITEM_ID, ore_item_id);
